...
def check_address(address, G):
    ...
    if location:
        ...
        if 29.7241 > location.latitude > 29.5801 and -82.2558 > location.longitude > -82.4289:
...
def main():
    ...
    algorithm = input("Choose an algorithm (A* or BFS): ").upper()
    ...
    if algorithm == "A*":
        ...
        print("Invalid algorithm choice. Please choose either A* or BFS.")
        sys.exit()
    ...
    if shortest_path_result:
        ...
        print("Would you like to see nodes visited or shortest route (nodes visited or shortest route): ", end="")
        user_input = input().strip()

        if user_input == "shortest route":
